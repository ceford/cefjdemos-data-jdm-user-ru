...
![позиции панели мониторинга atum](../../../en/images/modules/administrator-modules/01-atum-template-positions.png)
...
![список модулей админа atum](../../../en/images/modules/administrator-modules/02-atum-admin-modules-list.png)
...
![системное сообщение редактирования пользовательского модуля atum](../../../en/images/modules/administrator-modules/03-atum-admin-module-system-message.png)
