...
![форма многофакторной аутентификации параметров пользователей](../../../en/images/users/multi-factor-authentication/01-users-configuration-mfa.png)
...
![вид сайта формы многофакторной аутентификации пользователя](../../../en/images/users/multi-factor-authentication/02-multi-factor-authentication-site-profile.jpg)
