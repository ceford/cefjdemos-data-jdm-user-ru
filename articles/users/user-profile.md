...
![плагин профиля пользователя](../../../en/images/users/user-profile/01-user-profile-plugin.png)
...
![форма пункта меню профиля пользователя](../../../en/images/users/user-profile/02-user-profile-menu-item-form.png)

- Войдите на сайт и используйте ссылку, чтобы проверить профиль пользователя.

![форма пункта меню профиля пользователя](../../../en/images/users/user-profile/03-user-profile-edit.png.png)
