...
![Вкладка параметров управления пользователями](../../../en/images/users/user-registration/01-users-configuration-user-options.png)
...
![Страница ввода данных нового пользователя](../../../en/images/users/user-registration/02-users-new-user.png)
...
![Страница ввода данных нового пользователя](../../../en/images/users/user-registration/03-users-hover-block.png)
