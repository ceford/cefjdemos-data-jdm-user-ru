...
![форма меню входа с ограничением до доступа для гостей](../../../en/images/users/guest-access/01-guest-access-menu-login.png)
...
![форма меню выхода, ограниченная зарегистрированным доступом](../../../en/images/users/guest-access/02-guest-access-menu-logout.png)
