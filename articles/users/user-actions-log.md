...
![страница списка журнала действий пользователя](../../../en/images/users/user-actions-log/01-user-actions-log-list.png)
...
![страница параметров лога действий пользователя](../../../en/images/users/user-actions-log/02-user-actions-log-options.png)
...
![модуль журнала действий пользователя](../../../en/images/users/user-actions-log/03-user-actions-log-module.png)
