...
![форма меню выхода, ограниченная для зарегистрированного доступа](../../../en/images/users/login-and-logout-redirects/01-login-redirects-login-form.png)
...
![форма меню выхода, ограниченного доступом для зарегистрированных](../../../en/images/users/login-and-logout-redirects/02-login-redirects-login-menu-options.png)
...
![форма меню выхода, доступ ограничен зарегистрированными пользователями](../../../en/images/users/login-and-logout-redirects/03-login-redirects-logout-menu-options.png)
