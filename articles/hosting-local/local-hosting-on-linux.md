...
![менеджер пакетов synaptic](../../../en/images/hosting-local/local-hosting-on-linux/01-synaptic-package-manager-gui.png)
...
![страница apache по умолчанию](../../../en/images/hosting-local/local-hosting-on-linux/02-apache-default-page.png)
