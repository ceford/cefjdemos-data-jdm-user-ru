...
![менеджер пакетов synaptic](../../../en/images/hosting-local/synaptic-package-manager-gui.png)
...
![страница apache по умолчанию](../../../en/images/hosting-local/apache-default-page.png)
