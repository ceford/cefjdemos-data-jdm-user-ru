...
![список пунктов меню](../../../en/images/menus/menu-items/01-menus-all-menu-items-list.png)
...
![выбор типа пунктов меню](../../../en/images/menus/menu-items/02-menus-menu-items-select-type.png)
...
![редактирование пункта меню](../../../en/images/menus/menu-items/03-menus-menu-items-edit-item.png)
