...
![порядок перетаскивания элемента меню](../../../en/images/menus/menu-item-order/01-menus-menu-item-order-drag.png)
...
![список порядка элементов меню](../../../en/images/menus/menu-item-order/02-menus-menu-item-order-list.png)
