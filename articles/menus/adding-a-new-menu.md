...
![Список меню](../../../en/images/menus/adding-a-new-menu/01-menus-manage.png)
...
- В форме ввода данных для меню заполните следующие поля:
  ...
  - **Описание**: Хотя это поле не обязательно, оно часто бывает полезным на сайте с множеством меню. Описание отображается ниже *Заголовка* в списке меню, как показано выше.<br>
    ![Новое меню](../../../en/images/menus/adding-a-new-menu/02-menus-new.png)
- **Сохранить и закрыть**
...
![Форма ввода данных модуля Меню](../../../en/images/menus/adding-a-new-menu/03-menus-module.png)
...
![Форма ввода данных для пункта меню](../../../en/images/menus/adding-a-new-menu/04-menus-single-article.png)
...
![Отображение меню](../../../en/images/menus/adding-a-new-menu/05-menus-display.png)
