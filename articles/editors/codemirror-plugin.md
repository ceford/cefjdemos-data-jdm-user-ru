...
![Настройки плагина CodeMirror](../../../en/images/editors/codemirror-plugin/01-codemirror-plugin-tab.png)

Следующий скриншот демонстрирует подсветку HTML и *CMS Content*, реализованную в виде ряда кнопок:

![Использование CodeMirror](../../../en/images/editors/codemirror-plugin/02-codemirror-example.png)
