<!--
{
  ...
  "title": "Неподдерживаемая версия PHP",
  "description": "", 
  "author": ""
}
-->
...
![Извините, версия PHP не поддерживается](../../../en/images/problems/unsupported-php-version/01-problems-unsupported-php-version.png)
