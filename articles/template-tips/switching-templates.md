...
![страница списка стилей шаблонов сайта](../../../en/images/template-tips/switching-templates/01-switch-templates-styles-list.png)
...
![вкладка назначения пункта меню страницы редактирования стиля](../../../en/images/template-tips/switching-templates/02-switch-templates-styles-edit-style-menu-assignment.png)
...
![страница редактирования пункта меню показывающая выбор стиля](../../../en/images/template-tips/switching-templates/03-switch-templates-styles-edit-menu-style.png)
