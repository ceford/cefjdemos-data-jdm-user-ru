...
![форма редактирования модуля входа, вкладка дополнительно с пользовательским классом](../../../en/images/template-tips/module-and-menu-styles/01-templates-edit-module-style.png)
...
![вид сайта с настроенным модулем с инструментами разработчика](../../../en/images/template-tips/module-and-menu-styles/02-templates-edit-module-style-result.png)
...
![вид настроенной страницы сайта с инструментами разработчика](../../../en/images/template-tips/module-and-menu-styles/03-templates-edit-page-class-result.png)
