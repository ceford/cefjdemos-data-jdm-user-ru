...
![Ввод данных в модуле отображения ленты](../../../en/images/news-feeds/news-display/01-news-joomla-news-form.png)

Результат может выглядеть не очень, но его можно улучшить с помощью пользовательских стилей в user.css:

![Ввод данных в модуле отображения ленты](../../../en/images/news-feeds/news-display/02-news-joomla-news-display.png)
...
![Ввод компонентов данных NewsFeed](../../../en/images/news-feeds/news-display/03-news-feed-data-entry.png)
...
![Ввод данных пункта меню NewsFeed](../../../en/images/news-feeds/news-display/04-news-feed-menu-form.png)

Проверьте это: перейдите в меню Сайта и выберите пункт меню Лента.

![Отображение NewsFeed](../../../en/images/news-feeds/news-display/05-news-feed-display.png)
...
![Пользовательское отображение NewsFeed](../../../en/images/news-feeds/news-display/06-news-feed-custom-display.png)
...
![Форма меню канала новостей по категориям](../../../en/images/news-feeds/news-display/07-news-feed-menu-category-form.png)
