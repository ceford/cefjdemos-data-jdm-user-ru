<!--
{
  ...
  "title": "Статья: Редактировать - Метаданные ",
  "description": "", 
  "author": ""
}
-->
...
### Приоритеты заголовков страниц

В Joomla заголовок страницы метаданных используется в заголовке и отображается в
Вкладка браузера получена из одного из следующих источников по порядку:

1. Пункт меню > Отображение страницы > Заголовок страницы браузера (если задано в форме)
2. Статья > Параметры > Заголовок страницы браузера (если задано в форме).
3. Название статьи (для одной статьи без пункта меню)
4. Заголовок пункта меню (для составной страницы, например *Рекомендуемые статьи*).
или *Категорийный блог*)

Поэтому вам нужно подумать о составлении хороших описательных заголовков.
и заголовки страниц как для статей, так и для пунктов меню.

## Описание страницы

Статья *Мета Описание* - это поле на вкладке *Публикация* в форме ввода данных статьи:

![Форма редактирования статьи, вкладка публикации](../../../en/images/articles/article-metadata/01-articles-edit-publishing-tab.png)
