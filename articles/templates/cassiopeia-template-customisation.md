...
2. В диалоговом окне «Новый файл» выберите папку css, иначе новый файл появится не в том месте.
3. Введите user (строчными буквами и без .css) в поле «Имя файла» и выберите .css в поле «Тип файла».
4. Нажмите кнопку «Создать», чтобы создать файл.
