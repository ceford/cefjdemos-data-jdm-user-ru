...
![модуль входа, показывающий альтернативные макеты](../../../en/images/templates/template-layouts/01-layouts-module-login.png)
...
![форма редактирования языка](../../../en/images/templates/template-layouts/02-layouts-language-override-form.png)

Поле выбора макета модуля с переведенным **expires**:

![выбор альтернативных макетов модуля](../../../en/images/templates/template-layouts/03-layouts-example-translated.png)
```
...
![окно параметров статьи с списком альтернативных компоновок](../../../en/images/templates/template-layouts/04-layouts-articles-options.png)
...
![форма редактирования статьи с отображением списка альтернативных компоновок](../../../en/images/templates/template-layouts/05-layout-article-edit.png)
...
![форма параметров компонента контактов с отображением альтернативных макетов](../../../en/images/templates/template-layouts/06-layouts-contacts-options.png)
...
![форма параметров компонента контактов с отображением альтернативных макетов](../../../en/images/templates/template-layouts/07-layouts-contacts-category-options.png)
...
![форма параметров компонента контактов, показывающая альтернативные макеты](../../../en/images/templates/template-layouts/08-layouts-articles-options-category.png)
...
![список выбора пункта меню](../../../en/images/templates/template-layouts/09-layouts-menu-blog-menu-creation.png)
